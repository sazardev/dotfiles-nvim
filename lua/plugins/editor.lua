  ...
  -- ── Which-key — grupos de atajos flat Gruvbox ──
  {
    ...
    config = function(_, opts)
      ...
      wk.add({
        ...
        { "<leader>aqe", desc = "󰚩 Explain file",            mode = "n" },
        { "<leader>aqe", desc = "󰚩 Explain selection",       mode = "v" },
        { "<leader>aqd", desc = "󰚩 Document file",           mode = "n" },
        { "<leader>aqd", desc = "󰚩 Document selection",      mode = "v" },
        { "<leader>aqr", desc = "󰚩 Review file",             mode = "n" },
        { "<leader>aqr", desc = "󰚩 Review selection",        mode = "v" },
        { "<leader>aqf", desc = "󰚩 Fix selection",           mode = "v" },
        { "<leader>aqa", desc = "󰚩 Ask (file context)",      mode = "n" },
        ...
        { "<leader>ase", desc = "⚡ Explain file",            mode = "n" },
        { "<leader>ase", desc = "⚡ Explain selection",       mode = "v" },
        { "<leader>asd", desc = "⚡ Document file",           mode = "n" },
        { "<leader>asd", desc = "⚡ Document selection",      mode = "v" },
        { "<leader>asr", desc = "⚡ Review file",             mode = "n" },
        { "<leader>asr", desc = "⚡ Review selection",        mode = "v" },
        { "<leader>asa", desc = "⚡ Ask (file context)",      mode = "n" },
        { "<leader>asa", desc = "⚡ Ask about selection",     mode = "v" },
        { "<leader>asf", desc = "⚡ Explain function",        mode = "n" },
        { "<leader>asf", desc = "⚡ Explain selection as fn", mode = "v" },
        { "<leader>ass", desc = "⚡ Summarize file",          mode = "n" },
        { "<leader>ass", desc = "⚡ Summarize selection",     mode = "v" },
        { "<leader>ast", desc = "⚡ Translate → English",     mode = "v" },
        { "<leader>asi", desc = "⚡ Identify file purpose",   mode = "n" },
        { "<leader>asw", desc = "⚡ What is this symbol?",    mode = "n" },
        ...
        { "<leader>G",  group = "git" },
        -- changes (VS Code parity)
        { "<leader>Gu", desc = " Undo Last Commit" },
        { "<leader>Ge", desc = " Fetch" },
        { "<leader>Gs", desc = " Stash Push" },
        { "<leader>GS", desc = " Stash Pop" },
        { "<leader>Gk", desc = " Switch Branch" },
        { "<leader>Gn", desc = " New Branch" },
        { "<leader>Gq", desc = " Delete Branch" },
        { "<leader>Gm", desc = " Merge Branch" },
        { "<leader>Gw", desc = " Stage File" },
        { "<leader>GU", desc = " Unstage All" },
        { "<leader>GX", desc = " Discard All" },
        { "<leader>GE", desc = " Push (upstream)" },
        { "<leader>Gi", desc = " Status Info" },
        { "<leader>g", group = "go" },
